...
execute if predicate skys_horizon:spaceship/braking run scoreboard players operation #tmp1 skys_horizon.temp *= #brake_multiplier skys_horizon.spaceship.const
