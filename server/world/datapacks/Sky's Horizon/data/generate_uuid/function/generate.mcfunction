...
execute unless score @s gu.uuid.0 matches -2147483648.. run function generate_uuid:zzz/store_uuid
...
function generate_uuid:zzz/get_hexes with storage gu:temp
function generate_uuid:zzz/concat_uuid with storage gu:temp
