...
execute if score .entities cb matches 1.. at 00000063-0000-0077-0000-006300000062 run function callback_scheduler:internal/schedule/loop_entities

data remove storage cb jobs[0]
scoreboard players remove .jobs cb 1
execute if score .jobs cb matches 1.. run function callback_scheduler:internal/schedule/loop_jobs
