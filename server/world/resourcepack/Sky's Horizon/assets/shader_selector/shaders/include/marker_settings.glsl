...
#define SHAKE_CHANNEL 1
#define RADIATION_CHANNEL 2

/*
signature:
 ADD_MARKER(channel, red, op)
*/
// append different marker definitions
#define LIST_MARKERS ADD_MARKER(SHAKE_CHANNEL, 0, 1) ADD_MARKER(RADIATION_CHANNEL, 1, 1)

#define MARKER_ALPHA 254
