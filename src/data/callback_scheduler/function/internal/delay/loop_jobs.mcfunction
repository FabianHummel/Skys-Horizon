...
execute at 00000063-0000-0077-0000-006300000062 run function callback_scheduler:internal/delay/run_cmd with storage cb args

data remove storage cb jobs[0]
scoreboard players remove .jobs cb 1
execute if score .jobs cb matches 1.. run function callback_scheduler:internal/delay/loop_jobs
