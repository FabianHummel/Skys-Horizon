...
scoreboard players operation #tmp1 skys_horizon.temp /= #36.000 skys_horizon.const

# Red: (value >> 8) << 16
scoreboard players operation #tmp2 skys_horizon.temp = #tmp1 skys_horizon.temp
scoreboard players operation #tmp2 skys_horizon.temp /= #2^8 skys_horizon.const
scoreboard players operation #tmp2 skys_horizon.temp *= #2^16 skys_horizon.const
scoreboard players operation #out skys_horizon.temp = #tmp2 skys_horizon.temp

# Green (low 4 bits): (value % 2⁴) << 8
scoreboard players operation #tmp2 skys_horizon.temp = #tmp1 skys_horizon.temp
scoreboard players operation #tmp2 skys_horizon.temp %= #2^4 skys_horizon.const
scoreboard players operation #tmp2 skys_horizon.temp *= #2^8 skys_horizon.const
scoreboard players operation #out skys_horizon.temp += #tmp2 skys_horizon.temp
