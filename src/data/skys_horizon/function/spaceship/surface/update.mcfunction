...
execute store result entity @n[tag=skys_horizon.spaceship.model] transformation.right_rotation[2] double 0.01 run scoreboard players get @s skys_horizon.spaceship.steering
...
execute as @n[tag=skys_horizon.spaceship.model] at @s run function skys_horizon:spaceship/surface/apply_rotation with storage skys_horizon spaceship
function skys_horizon:spaceship/surface/apply_rotation with storage skys_horizon spaceship
execute rotated as @n[tag=skys_horizon.spaceship.model] run rotate @n[tag=skys_horizon.spaceship.base] ~ ~
...
execute store result entity @n[tag=skys_horizon.spaceship.model] transformation.right_rotation[3] double -0.01 run scoreboard players get #tmp1 skys_horizon.temp
