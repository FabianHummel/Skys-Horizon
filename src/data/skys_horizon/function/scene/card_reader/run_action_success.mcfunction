...
function callback_scheduler:schedule {ticks: 50, selector: "@s", command: 'data modify entity @n[type=minecraft:item_display,tag=skys_horizon.scene.card_reader.lamp] item.id set value \\"minecraft:red_stained_glass\\"'}
