...
execute as @e[tag=skys_horizon.interactable] at @s store result entity @n[type=minecraft:item_display] Glowing byte 1 if entity @s[tag=skys_horizon.interactable.active]
