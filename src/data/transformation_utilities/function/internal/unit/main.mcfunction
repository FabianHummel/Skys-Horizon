...
execute if score $a tu.math matches 1.. run return run function transformation_utilities:internal/unit/pos with storage tu:data unit
function transformation_utilities:internal/unit/neg with storage tu:data unit
